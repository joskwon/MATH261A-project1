...
The National Football League, NFL for short, is the most popular sport in America with 41% of U.S. adults claiming football as their "favorite sport" [@Gallup] according to a Gallup poll. This popularity has driven an increase in lucrative media deals for the league, which in return has driven an increase in player salary demands. To prevent wealthier teams from spending their way to dominance and to maintain competition in the league, policies have been enacted to ensure a balanced competitive field, such as the draft and salary cap. The salary cap, "calculated annually based on a collectively bargained formula tied to league revenues" according to [@ESPN], limits the amount of money an NFL team can spend in a given year.  

This is interesting in particular due to its implications on team structure. 
